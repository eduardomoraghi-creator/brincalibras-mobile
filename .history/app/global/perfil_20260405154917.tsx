...
export default function PerfilScreen() {
  ...
  const onFotoUsuarioPress = async () => {
  ...
  const onSalvarNome = () => {
    ...
    Alert.alert(
      "Nome",
      "A edição de nome depende do endpoint de atualização cadastral.",
    );
  };
  ...
  const onSalvarEmail = () => {
    ...
    Alert.alert(
      "E-mail",
      "A edição de e-mail depende do endpoint de atualização cadastral.",
    );
  };
    ...
    >
      ...
      >
        ...
        >
          <View style={styles.metaHeaderRow}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Text style={[styles.metaShareIcon, { color: theme.primary }]}>
                ⤴
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.imageCard}>
          ...
          <Text
            style={[styles.nomeOverlayText, { color: theme.overlayText }]}
            numberOfLines={1}
          >
            {nomeExibicao}
          </Text>
          ...
          <Text
            style={[styles.emailOverlayText, { color: theme.overlayText }]}
            numberOfLines={1}
          >
            {emailExibicao}
          </Text>
