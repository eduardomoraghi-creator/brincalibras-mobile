...
export default function MedalhasScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: "Medalhas" }} />
        ...
        >
              ...
              return (
                <View key={atividade.id} style={styles.itemCard}>
                  ...
                  <Text style={styles.itemMeta}>
                    {atividade.progresso} de {atividade.total} atividades
                    concluídas
                  </Text>
                </View>
              );
          ...
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>
              A estrutura desta tela já está pronta para receber novas
              categorias, como alimentos, cores, números, escola e animais.
            </Text>
          </View>
        </ScrollView>
      </SafeAreaView>
