...
import medalhasImg from "../../src/assets/images/brincaLibrasTCC/medalhas.png";
import compartilheAppImg from "../../src/assets/images/brincaLibrasTCC/compartilhe-app.png";
C:\TCC\brincalibras-mobile\app\global\perfil.tsx
const LIGHT = {
  primary: "#2D9CDB",
  background: "#EDEDED",
  card: "#F5F5F5",
