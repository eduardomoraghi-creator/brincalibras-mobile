...
const HAND_IMAGE = require("../../../../assets/images/mao.png");

const LEVEL_CONFIG: Record<
  Level,
  { columns: number; pairs: number; label: string }
> = {
  easy: { columns: 3, pairs: 6, label: "Fácil" },
  medium: { columns: 3, pairs: 10, label: "Médio" },
      ...
      >
        ...
        >
          {isSign ? (
            <Image
              source={HAND_IMAGE}
              style={styles.cardBackHandImage}
              resizeMode="contain"
            />
          ) : (
          ...
          {isSign ? (
            <View style={styles.signContent}>
              ...
              {card.signalAsset ? (
                ...
                <Text
                  style={[styles.signMissing, { color: colors.signMissing }]}
                >
      ...
      >
        <View style={styles.container}>
          <View style={styles.startContainer}>
            ...
            <View
              style={[styles.startCard, { backgroundColor: colors.surface }]}
            >
      ...
      <View style={styles.container}>
        ...
        {!gameFinished && (
          ...
          >
            <Text
              style={[
                styles.feedbackText,
                { color: darkMode ? "#000000" : colors.textSecondary },
              ]}
            >
              {feedback}
            </Text>
        ...
        <FlatList
          ...
          contentContainerStyle={[
            styles.grid,
            !gameFinished && styles.gridFullscreen,
          ]}
          columnWrapperStyle={
            config.columns > 1 ? styles.columnWrapper : undefined
          }
          renderItem={({ item }) => (
            <MemoryCard
              card={item}
